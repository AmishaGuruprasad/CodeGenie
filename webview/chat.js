...
async function sendMessage(message) {
  ...
  console.log("selected elements =", document.getElementsByClassName("selected"));
  if (old_chat) {
...
async function loadChatHistory(chatId) {
  ...
  try {
    ...
    if (messages){
      ...
      errorMessageContainer.classList.add("sidebar-error-container");

      let messageText = document.createElement("div");
      messageText.innerText = "Error loading chat history";
      messageText.classList.add("sidebar-error-message");

      let retryButton = document.createElement("button");
      retryButton.innerText = "↻";
      retryButton.classList.add("sidebar-retry-button");
      ...
      responseArea.appendChild(errorMessageContainer);
  }
  finally{}
  responseArea.scrollTop = responseArea.scrollHeight;
}
...
async function fetchChatList() {
  try {
    ...
    chats.forEach((chat) => {
      ...
      let messageText = document.createElement("div");
      messageText.innerText = "Error loading chats";
      messageText.classList.add("sidebar-error-message");
      ...
      retryButton.addEventListener("click", fetchChatList);

      errorMessageContainer.appendChild(messageText);
      errorMessageContainer.appendChild(retryButton);

      sidebar.appendChild(errorMessageContainer);
